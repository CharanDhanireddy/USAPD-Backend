SELECT to_char(multiStatePollutantData.date_str2, 'MM') as month,
              extract(year from multiStatePollutantData.date_str2) as year, siteData.state_name AS state,
...
GROUP  BY to_char(multiStatePollutantData.date_str2, 'MM'), extract(year from multiStatePollutantData.date_str2), siteData.state_name
ORDER  BY siteData.state_name, year, month;